        ...
        <form action="{{ route('employees.update', $employee->id) }}" method="POST"
            ...
            <div>
                ...
                <textarea id="address" name="address" rows="3"
                    class="w-full border-gray-300 rounded-xl shadow-sm px-4 py-3
                          focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">{{ old('address', $employee->address) }}</textarea>
            </div>
            ...
            <div>
                ...
                <select id="status" name="status"
                    ...
                    <option value="non-active" {{ old('status', $employee->status) === 'non-active' ? 'selected' : '' }}>
                        Nonaktif
                    </option>
                </select>
            </div>
