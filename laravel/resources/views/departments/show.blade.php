...
@section('content')
    <div class="max-w-6xl mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <!-- Kolom Kiri: Detail Departemen (Minimalist Card) -->
            <div class="space-y-6">

                <!-- Card Detail Departemen -->
                <div class="bg-white shadow-xl rounded-2xl p-6 border border-gray-200">
                    ...
                    <div class="space-y-4 text-sm">
                        ...
                        <p class="flex justify-between border-b border-dashed border-gray-100 pb-1">
                            <span class="font-medium text-gray-500">Nama Departemen</span>
                            <span class="text-gray-900 font-semibold">{{ $department->department_name }}</span>
                        </p>
            ...
            <div class="hidden md:block">
                <div class="bg-gray-900 rounded-2xl h-full shadow-xl overflow-hidden border border-gray-200">
                    ...
                    <img src="https://i.pinimg.com/1200x/34/1c/0b/341c0ba5b52d78ae5edae723e232d335.jpg"
                         alt="Ilustrasi Detail Departemen"
